...
#define WiimoteDeviceIsPointEqual(a, b) \
    (WiimoteDeviceIsFloatEqual((a).x, (b).x) && WiimoteDeviceIsFloatEqual((a).y, (b).y))

#define WiimoteDeviceIsPointEqualEx(a, b, epsilon) \
    (WiimoteDeviceIsFloatEqualEx((a).x, (b).x, (epsilon)) && WiimoteDeviceIsFloatEqualEx((a).y, (b).y, (epsilon)))
...
\
        if ((value) <= (center)) \
        { \
            wiimote_device_norm_value_ = ((CGFloat)(value) - (CGFloat)(min)) / ((CGFloat)(center) - (CGFloat)(min)) - 1.0f; \
        } \
        else \
        { \
            wiimote_device_norm_value_ = ((CGFloat)(value) - (CGFloat)(center)) / ((CGFloat)(max) - (CGFloat)(center)); \
        } \
\
